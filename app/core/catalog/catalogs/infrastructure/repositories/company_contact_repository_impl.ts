import CompanyContact from '#core/catalog/catalogs/domain/models/company_contact'
import type CompanyContactRepository from '#core/catalog/catalogs/domain/interfaces/company_contact_repository'
