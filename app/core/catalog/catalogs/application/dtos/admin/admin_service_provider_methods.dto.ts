...
import type ServiceProviderMethod from '#core/catalog/catalogs/domain/models/service_provider_method'
...
} from '#core/catalog/catalogs/domain/types/service_provider_method_repository_types'
