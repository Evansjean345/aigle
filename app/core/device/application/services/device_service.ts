...
import FailedToSaveOrUpdateDeviceException from '#core/device/domain/exceptions/failed_to_save_or_update_device_exception'
import UnauthenticatedDeviceException from '#core/device/domain/exceptions/unauthenticated_device_exception'
import FailedToUpdatePushTokenException from '#core/device/domain/exceptions/failed_to_update_push_token_exception'
import MaxDevicesConnectedException from '#core/device/domain/exceptions/max_devices_connected_exception'
