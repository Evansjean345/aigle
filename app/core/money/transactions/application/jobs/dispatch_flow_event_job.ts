...
const EVENT_MAP = {
  DepositTransactionCompleted: () =>
    import('#core/money/transactions/application/events/deposit_transaction_completed'),
  DepositTransactionFailed: () =>
    import('#core/money/transactions/application/events/deposit_transaction_failed'),
  TransfertTransactionCompleted: () =>
    import('#core/money/transactions/application/events/transfert_transaction_completed'),
  TransfertTransactionFailed: () =>
    import('#core/money/transactions/application/events/transfert_transaction_failed'),
  TransfertInterTransactionFailed: () =>
    import('#core/money/transactions/application/events/transfert_inter_transaction_failed'),
} as const
