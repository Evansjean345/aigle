...
const Hub2WebhookController = () =>
  import('#core/money/webhooks/presentation/provider/controllers/hub2_webhook_controller')
const WaveWebhookController = () =>
  import('#core/money/webhooks/presentation/provider/controllers/wave_webhook_controller')
