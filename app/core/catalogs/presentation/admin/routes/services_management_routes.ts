...
const ServiceTypesController = () =>
  import('#core/catalogs/presentation/admin/controllers/service_types_controller')
const PaymentMethodsController = () =>
  import('#core/catalogs/presentation/admin/controllers/payment_methods_controller')
const ProvidersController = () =>
  import('#core/catalogs/presentation/admin/controllers/providers_controller')
