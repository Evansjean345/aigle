...
} from '#core/identity/authentication/presentation/mobile/validators/auth_validator'
...
import { LoginRequestDto } from '#core/identity/authentication/application/dtos/login.dto'
import { RegisterRequestDto } from '#core/identity/authentication/application/dtos/register.dto'
