...
} from '#core/authentication/presentation/mobile/validators/auth_validator'
import RegisterUseCase from '#core/authentication/application/use_cases/register_use_case'
import SendOtpUseCase from '#core/authentication/application/use_cases/send_otp_use_case'
import CheckPinUseCase from '#core/authentication/application/use_cases/check_pin_use_case'
import GetUserProfileUseCase from '#core/authentication/application/use_cases/get_user_profile_use_case'
import LogoutUseCase from '#core/authentication/application/use_cases/logout_use_case'
import CheckPhoneUseCase from '#core/authentication/application/use_cases/check_phone_use_case'
import ResetPasswordUseCase from '#core/authentication/application/use_cases/reset_password_use_case'
import { AuthenticatedProfileResponseDto } from '#core/authentication/application/dtos/profile.dto'
import VerifyAndAuthenticateUserAccountUseCase from '#core/authentication/application/use_cases/verify_and_authenticate_user_account_use_case'
import VerifyForgotPasswordOtpUseCase from '#core/authentication/application/use_cases/verify_forgot_password_otp_use_case'
import User from '#core/user/domain/models/user'
import { LoginRequestDto } from '#core/authentication/application/dtos/login.dto'
import { RegisterRequestDto } from '#core/authentication/application/dtos/register.dto'
import { VerifyAccountRequestDto } from '#core/authentication/application/dtos/verify_account.dto'
import VerifyCredentialsUseCase from '#core/authentication/application/use_cases/verify_credentials_use_case'
import GetSessionStatusUseCase from '#core/authentication/application/use_cases/get_session_status_use_case'
