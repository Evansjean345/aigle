...
import InvalidTokenException from '#core/team/infrastructure/exceptions/invalid_token_exception'
import ExpiredTokenException from '#core/team/infrastructure/exceptions/expired_token_exception'
...
import { SetupAdminPasswordRequestDto } from '#core/authentication/application/dtos/admin/setup_admin_password.dto'
