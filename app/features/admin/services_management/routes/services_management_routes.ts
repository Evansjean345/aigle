...
const ServiceTypesController = () =>
  import('#admin/services_management/controllers/service_types_controller')
const PaymentMethodsController = () =>
  import('#admin/services_management/controllers/payment_methods_controller')
const ProvidersController = () =>
  import('#admin/services_management/controllers/providers_controller')
const ServiceProviderMethodsController = () =>
  import('#admin/services_management/controllers/service_provider_methods_controller')
