...
const TransfertInterWebhookController = () => import('#mobile/webhooks/controllers/transfert_inter_webhook_controller')
...
const mobileWebhookRoutes = () =>
  router
    .group(() => {
      ...
      router.post('transfer-inter/second/success', [TransfertInterWebhookController, 'interSecondSuccess'])
      router.post('transfer-inter/second/failure', [TransfertInterWebhookController, 'interSecondFailure'])
    })
