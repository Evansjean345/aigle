...
export default class PaymentService {
   ...
   */
  async getByUidOrId(id: string | number, trx?: TransactionClientContract): Promise<Payment> {
    const payment = await this.paymentRepository.findByUidOrId(id, trx)
  ...
  async markSuccess(
    ...
    const payment = await this.getByUidOrId(id, trx)
