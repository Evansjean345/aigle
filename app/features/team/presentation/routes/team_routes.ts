...
const TeamManagementController = () =>
  import('#features/team/presentation/controllers/team_management_controller')

const RoleManagementController = () =>
  import('#features/team/presentation/controllers/role_management_controller')

const PermissionManagementController = () =>
  import('#features/team/presentation/controllers/permission_management_controller')
