...
const Hub2WebhookController = () =>
  import('#features/webhooks/presentation/provider/controllers/hub2_webhook_controller')
const WaveWebhookController = () =>
  import('#features/webhooks/presentation/provider/controllers/wave_webhook_controller')
