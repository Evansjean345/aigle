...
import CheckAppUpdateUseCase from '#features/device/application/use_cases/mobile/check_app_update_use_case'
import { checkUpdateValidator } from '#features/device/presentation/mobile/validators/app_version_validator'
