...
export const BUSINESS_PERMISSIONS: readonly BusinessPermission[] = [
  ...
  {
    slug: 'transfer:initiate',
    name: 'Initier un transfert',
    description: 'Initier un transfert (ou un transfert de masse).',
    sensitive: true,
  },
  {
    slug: 'transfer:approve',
    name: 'Approuver un transfert',
    description: 'Approuver un transfert en attente (maker-checker).',
    sensitive: true,
  },
  {
...
export const BUSINESS_PERMISSION = {
  ...
  kybView: 'kyb:view',
  qrManage: 'qr:manage',
  transferInitiate: 'transfer:initiate',
