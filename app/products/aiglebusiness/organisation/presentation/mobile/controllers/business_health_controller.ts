 ...
 *
 * Le socle (sous-lot 0) : ce contrôleur atteste que la couche présentation du
 * module boote. Les couches domain/application/infrastructure sont introduites
 * avec la feature Organisation (sous-lot 1).
 */
