...
/**
 * Repository class for managing providers, implementing the `ProviderRepositoryContract` interface.
 * Handles operations such as pagination, retrieval, creation, updates, and deletion of providers.
 */
export default class ProviderRepository implements ProviderRepositoryContract {
  /**
