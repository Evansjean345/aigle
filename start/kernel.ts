...
export const middleware = router.named({
  ...
  activeOrganisation: () =>
    import(
      '#aiglebusiness/organisation/presentation/client/middleware/active_organisation_middleware'
    ),

  requireEnterprise: () => import('#aiglebusiness/shared/middleware/require_enterprise_middleware'),
