...
export const waveWebhookCheckoutSuccessSecret = env.get('WAVE_WAVE_CHECKOUT_SUCCESS_SECRET') ?? ''
export const waveWebhookCheckoutErrorSecret = env.get('WAVE_WEBHOOK_CHECKOUT_ERRORS_SECRET') ?? ''
