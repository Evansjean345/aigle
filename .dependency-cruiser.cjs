  ...
  forbidden: [
    {
      ...
      to: { path: 'app/features/[^/]+/(application|infrastructure|presentation)' },
    },
    {
      ...
      to: { path: 'app/features/[^/]+/(infrastructure|presentation)' },
    },
    {
      ...
      to: { path: 'app/features/[^/]+/(domain/models|infrastructure)' },
    },
    {
